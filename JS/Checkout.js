let items = [
    { id: 1, name: 'Item 1', price: 10.00, amount: 1 },
    { id: 2, name: 'Item 2', price: 15.50, amount: 1 },
...
function itemBox() {
    return getDiv('d-flex justify-content-start align-items-center justify-content-between')
}
